...
%`
      const ques = question + "use below weather data for referance " + sent
      console.log(sent)
      ...
      <div className="bg-gradient-to-r from-blue-50 to-blue-100 h-screen p-3 flex flex-col justify-center items-center">
        ...
        >
          <a href="https://github.com/Vishesh-Pandey/chat-ai" target="_blank" rel="noopener noreferrer">
            <h1 className="text-4xl font-bold text-blue-500 mb-4 animate-bounce">Weather Chat Bot</h1>
          </a>
          <input type="text" name="location" placeholder="Location" className="border border-gray-300 rounded w-full my-2 min-h-fit p-3 transition-all duration-300 focus:border-blue-400 focus:shadow-lg" style={{ outline: "none" }} value={loca} onChange={(e) => { setLoca(e.target.value) }} />
          <textarea
            required
